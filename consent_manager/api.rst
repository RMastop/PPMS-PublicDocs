...
.. function:: onFulfilled(types)
    ...
    The fulfilment handler callback (called with result). This function is **required**.
...
.. function:: onFulfilled()
    ...
    The fulfilment handler callback. This function is **required**.
...
.. literalinclude:: examples/api_full_example.rst